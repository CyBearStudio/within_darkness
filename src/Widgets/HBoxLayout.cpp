...
HBoxLayout::HBoxLayout(float offset, Anchors::Flags anchor) : Widget(anchor), mOffset(offset)
{
}
...
void HBoxLayout::setOffset(float offset) 
{
    if (offset != mOffset)
    {
        // set new offset
...
void HBoxLayout::onDraw(sf::RenderTarget& target, sf::RenderStates states) const 
{
    // nothing here
}

void HBoxLayout::onUpdateTransform() 
{
